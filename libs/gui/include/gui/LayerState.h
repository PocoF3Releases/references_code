...
struct layer_state_t {
...
#if MI_SCREEN_PROJECTION
        //MIUI ADD:
        eLayerCast = 0x800,  // FLAG_CAST in SurfaceControl.java
#endif
    };
...
#if MI_SCREEN_PROJECTION
        //MIUI ADD:
        eScreenProjected = 0x00000200,
#endif
#ifdef MI_SF_FEATURE
        eShadowChanged = 0x10000'00000000,
#endif
#ifdef MI_SF_FEATURE
        // MIUI ADD: HDR Dimmer
        eHdrDimmerChanged = 0x20000'00000000,
        eHdrDimmerRatioChanged = 0x40000'00000000,
#endif
    };
    ...
    half4 shadowColor;
    float shadowOffset[2] = {0.f, 0.f};
    float shadowOutset = 0.f;
    int32_t shadowLayers = 0;
#endif
#ifdef MI_SF_FEATURE
    // MIUI ADD: HDR Dimmer
...
struct DisplayState {
    enum {
        ...
        // MIUI ADD:
        eLimitedFrameRateChanged = 0x100,
        // END
#endif
#ifdef MI_SF_FEATURE
        eIsDisplaySecurityChanged = 0x200,
#endif
    };
...
#if MI_VIRTUAL_DISPLAY_FRAMERATE
    // MIUI ADD:
    uint32_t limitedFrameRate;
    // END
#endif
#ifdef MI_SF_FEATURE
    bool isDisplaySecurity = false;
#endif

...
class DnsProxyListener : public FrameworkListener {
  ...
  private:
    ...
    // MI ADD START:
    class SetOperatorAddressDnsCmd : public FrameworkCommand {
      public:
        SetOperatorAddressDnsCmd();
        virtual ~SetOperatorAddressDnsCmd() {}
        int runCommand(SocketClient* c, int argc, char** argv) override;
    };
    class SetOperatorAddressDnsHandler : public Handler {
      public:
        SetOperatorAddressDnsHandler(SocketClient* c, std::string address);
        ~SetOperatorAddressDnsHandler() override = default;
        void run() override;
        std::string threadName() override;

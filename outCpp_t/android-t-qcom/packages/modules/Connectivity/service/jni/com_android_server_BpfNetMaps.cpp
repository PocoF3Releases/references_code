...
// MIUI ADD: START
static void native_updateAurogonUidRule(JNIEnv* env, jobject clazz, jint uid, jboolean allow) {
    mTc.updateAurogonUidRule(uid, allow);
}
// END
...
static const JNINativeMethod gMethods[] = {
    ...
    (void*)native_dump},
    // MIUI ADD: START
    {"native_updateAurogonUidRule", "(IZ)V",
    (void*)native_updateAurogonUidRule},
     // END
};
// clang-format on

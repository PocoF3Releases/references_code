...
extern void SbcAnalysisSets16X(int index);
extern void SbcAnalysisSaves16X(int index);
...
extern void SbcAnalysisFilter4Left(SBC_ENC_PARAMS* strEncParams, int16_t* input);
extern void SbcAnalysisFilter8Left(SBC_ENC_PARAMS* strEncParams, int16_t* input);
extern void SbcAnalysisFilter4Right(SBC_ENC_PARAMS* strEncParams, int16_t* input);
extern void SbcAnalysisFilter8Right(SBC_ENC_PARAMS* strEncParams, int16_t* input);

...
/*
 * Block group cache entry structure
 */
struct ext2_block_group_cache_ent
{
	struct ext2_block_group_cache_ent *next;
	dgrp_t group;
};

/*
 * Block group cache structure
 */
struct ext2_block_group_cache
{
	int max;
	int count;
	struct ext2_block_group_cache_ent *head;
};
...
#define BLOCK_FLAG_EXTENT_WAY	16
...
extern errcode_t ext2fs_get_next_inode(ext2_inode_scan scan, ext2_ino_t *ino,
			       struct ext2_inode *inode);
/* Scan inode from specified block group */
extern errcode_t ext2fs_get_next_inode_full_ex(ext2_inode_scan scan,
					    ext2_ino_t *ino,
					    struct ext2_inode *inode,
					    int bufsize,
					    dgrp_t *group);
extern errcode_t ext2fs_open_inode_scan_ex(ext2_filsys fs, int buffer_blocks, dgrp_t group,
				 struct ext2_block_group_cache *blk_grp_cache, ext2_inode_scan *ret_scan);
extern errcode_t ext2fs_get_next_inode_ex(ext2_inode_scan scan, ext2_ino_t *ino,
				struct ext2_inode *inode, dgrp_t *group);
...
extern int ext2fs_is_block_group_cached(struct ext2_block_group_cache* cache, dgrp_t group);
extern dgrp_t ext2fs_get_next_block_group(struct ext2_block_group_cache* cache, dgrp_t group);
extern void ext2fs_block_group_reference(struct ext2_block_group_cache* cache, dgrp_t group);
extern void ext2fs_empty_block_group_cache(struct ext2_block_group_cache* cache);
extern void ext2fs_release_block_group_cache(struct ext2_block_group_cache* cache);
extern struct ext2_block_group_cache* ext2fs_create_block_group_cache(int max_groups);

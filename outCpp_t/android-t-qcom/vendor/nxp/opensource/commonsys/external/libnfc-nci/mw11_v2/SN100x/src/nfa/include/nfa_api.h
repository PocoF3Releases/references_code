...
#define NFC_BIGDATA_EXCEPTION 1
...
typedef void(tNFA_EXCEPTION_REPORTER_CBACK)(std::string value);
extern tNFA_EXCEPTION_REPORTER_CBACK* exception_reporter_cback;
extern void NFA_registExceptionReporter(tNFA_EXCEPTION_REPORTER_CBACK* cback);

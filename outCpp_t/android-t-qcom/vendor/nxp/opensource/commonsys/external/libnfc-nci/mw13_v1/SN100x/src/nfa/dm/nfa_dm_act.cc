...
static void nfa_dm_nfc_response_cback(tNFC_RESPONSE_EVT event,
  ...
  switch (event) {
    ...
    case NFC_RF_INTF_EXT_STOP_REVT:
      ...
      break;
#endif
    case NFC_RF_PHASE_REVT: /* RF Phase information            */
      dm_cback_data.rf_phase.status = NFA_STATUS_OK;
      dm_cback_data.rf_phase.rf_phase_status = p_data->rf_phase.rf_phase;
      (*nfa_dm_cb.p_dm_cback)(NFA_DM_RF_PHASE_EVT, &dm_cback_data);
      break;
    default:
      break;
  }
...
/*******************************************************************************
**
** Function         nfa_dm_is_hci_supported
**
** Description      This function returns TRUE, if NFA-EE is enabled and
**                  HCI network is supported
**
** Returns          TRUE, if HCI network is supported
**                  FALSE, otherwise
**
*******************************************************************************/
bool nfa_dm_is_hci_supported (void)
{

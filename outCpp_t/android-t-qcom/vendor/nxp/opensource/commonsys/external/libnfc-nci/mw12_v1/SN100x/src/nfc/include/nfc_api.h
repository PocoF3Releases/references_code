...
#define NFC_NXP_MW_VERSION_MAJ (0x10) /* MW Major Version */
...
#define NXP_NFC_PARAM_ID_SWPUICC3 \
  ((unsigned char)0xDC) /* SWP1 parameter ID  UICC3 */
...
#endif
  ,NFC_RF_PHASE_REVT               /* 25 RF Phase information          */
};
...
/* the data type associated with NFC_RF_PHASE_REVT */
typedef struct {
  tNFC_STATUS status;   /* The event status - place holder. */
  uint8_t rf_phase; /* phase  value                  */
} tNFC_RF_PHASE_REVT;

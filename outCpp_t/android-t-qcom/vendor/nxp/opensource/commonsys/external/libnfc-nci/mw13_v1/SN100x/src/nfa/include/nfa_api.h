...
#endif
 tNFA_DM_RF_PHASE rf_phase;          /* NFA_DM_RF_FIELD_EVT      */
} tNFA_DM_CBACK_DATA;
...
/* add for bigdata collect start*/
#define NCI_MSG_CORE_RF_PHASE 0x18

#define NFC_BIGDATA_LENGTH 2
#define NFC_BIGDATA_TYPE_EXCEPTION 1
#define NFC_BIGDATA_TYPE_RFPHASE 2

#define ABORT_MAX_RETY              0x01
#define ABORT_CLOSE_HAL_ERROR       0x02
#define ABORT_FW_ASSERT             0x03
#define ABORT_WATCHDOG_RESET        0x04
#define ABORT_INPUT_CLOCK_LOST      0x05
#define ABORT_OVER_TEMPERATURE      0x06
#define ABORT_UNRECOVERABLE_ERROR   0x07
#define ABORT_UNKNOW_ERROR          0x08

#define NAME_CMD_TIEMOUT "cmd_timeout"
#define NAME_SEMANTIC_ERROR "semantic_error"
#define NAME_ENABLE_CALLBACK_NULL "callback_null"
#define NAME_RESTART_NFC_SERVICE "req_from_hal"
#define NAME_HAL_SERVICE_DIED "hal_service_died"
#define NAME_ABORT_MAX_RETY "max_retry"
#define NAME_ABORT_CLOSE_HAL_ERROR "close_hal_error"
#define NAME_ABORT_FW_ASSERT "fw_assert"
#define NAME_ABORT_WATCHDOG_RESET "watchdog_reset"
#define NAME_ABORT_INPUT_CLOCK_LOST "clock_lost"
#define NAME_ABORT_OVER_TEMPERATURE "over_temperature"
#define NAME_ABORT_UNRECOVERABLE_ERROR "unrecoverable_error"
#define NAME_ABORT_UNKNOW_ERROR "hal_unknow_error"
#define NAME_DISC_NTF_TIMEOUT_ERROR "dis_ntf_timeout"
#define NAME_ABORT_FROM_NFCSERVICE "req_from_nfcservice"
#define NAME_CORE_GENERIC_ERROR "core_generic_error:"
#define NAME_CORE_INTERFACE_ERROR "core_interface_error:"
#define NAME_NFCEE_ESE_REBOOT "ese_reboot_c091"
#define NAME_RF_PHASE_VALUE "rf_phase_"

typedef void(tNFA_BIGDATA_REPORTER_CBACK)(int type, std::string value);
extern tNFA_BIGDATA_REPORTER_CBACK* nfc_bigdata_reporter_cback;
extern void NFA_registerBigDataReporter(tNFA_BIGDATA_REPORTER_CBACK* cback);
extern std::string formatValueFromHal(uint8_t value);
extern std::string formatToHEXString(uint8_t value);
extern void reportException(std::string value);
extern void reportRfPhase(std::string value);
extern void nfc_bigdata_report_rf_phase(uint8_t* p, uint8_t len);
/* add for bigdata collect end*/
#endif /* NFA_API_H */

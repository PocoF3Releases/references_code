...
struct uwb_jni_native_data {
  ...
  jclass rframeDataClass;
  jclass rframeMeasuresClass;
  jclass loopTestStatusClass;
  jclass getBindingStatusClass;
  jclass bindStatusClass;
  jclass getBindingCountClass;
  jclass getAllUwbSessionClass;
  jclass startConnectivityTestStatusClass;
  jclass sessionDataClass;
  jclass periodicTxDataClass;
  jclass perRxDataClass;
  jclass schedulerStatusDataClass;
  jclass schedSessionDataClass;
  jclass uwbLoopBackDataClass;
  jclass multicastUpdateListDataClass;
  jclass uartConnectivityTestStatusClass;
};

...
#define UCI_GID_APP_DATA_MANAGE 0x09  /* 1001b Data Control */
...
/* UCI Data Format:
 * byte 0: MT(0) PBF RFU
 * byte 1: Extended payload Length indicator (0x00)
 * byte 2: Data Length
 * byte 3: Data Length */
...
#define UCI_MSG_SESSION_GET_POSSIBLE_RAN_MULTIPLIER_VALUE  0x20
...
typedef enum {
  ...
  UWB_SESSION_URSK_TTL_MAX_VALUE_REACHED = 0x03,

...
**
** Description      BTIF storage API  Checks if the given device is ble specifified device
**
** Returns          TURE if found device
**
*******************************************************************************/
...
**
** Description      BTIF storage API  Checks if the given device is att secure level 0 device
**
** Returns          BT_STATUS_SUCCESS
**
*******************************************************************************/

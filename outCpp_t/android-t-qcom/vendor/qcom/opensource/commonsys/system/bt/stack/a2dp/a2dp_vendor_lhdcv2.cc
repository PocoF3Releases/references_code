...
bool A2DP_VendorDumpCodecInfoLhdcV2(const uint8_t* p_codec_info) {
  tA2DP_STATUS a2dp_status;
  tA2DP_LHDC_CIE lhdc_cie;
...
const char* A2DP_VendorCodecIndexStrLhdcV2(void) { return "LHDC_V2"; }
...
A2dpCodecConfigLhdcV2::A2dpCodecConfigLhdcV2(
    ...
    : A2dpCodecConfig(BTAV_A2DP_CODEC_INDEX_SOURCE_LHDCV2, "LHDC_V2",
                      codec_priority) {

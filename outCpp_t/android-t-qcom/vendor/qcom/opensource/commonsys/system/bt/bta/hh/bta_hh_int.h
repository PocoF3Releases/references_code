...
#define BTA_HH_LE_SCPS_NOTIFY_ENB 0x02
  ...
  uint8_t register_notify; /* if the report has been done cccd*/
#define BTA_HH_LE_NOTIFY_NONE 0x00
#define BTA_HH_LE_NOTIFY_CLEAN 0x01
#define BTA_HH_LE_NOTIFY_REGISTER 0x02

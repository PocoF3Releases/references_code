...
*
*
*  Copyright (c) 2012-2013, 2015-2017, 2019, 2022 Qualcomm Technologies, Inc.
*  All Rights Reserved.
...
typedef enum MMEventType {
  ...
  MM_EVENT_AUDIO_CREATED,
  MM_EVENT_AUDIO_DELETED,
  MM_EVENT_VIDEO_CREATED,
  MM_EVENT_VIDEO_DELETED,
  MM_EVENT_IMAGE_CREATED,
  MM_EVENT_IMAGE_DELETED,
  MM_EVENT_EDID,
  MM_EVENT_NOTIFY_G2G_LATENCY,
  MAX_EVENT
}MMEventType;

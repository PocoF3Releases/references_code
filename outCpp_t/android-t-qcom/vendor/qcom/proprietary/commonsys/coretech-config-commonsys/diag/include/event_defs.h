...
/*=======================================================================
Copyright (c) 2001-2021 Qualcomm Technologies, Inc.
All Rights Reserved.
...
typedef enum
{
  ...
  EVENT_F_RESERVED_89                                                            = 0xCCE, /* 3278 */
  EVENT_NR5G_RRC_MCG_FAILURE                                                     = 0xCCF, /* 3279 */
  EVENT_F_RESERVED_90                                                            = 0xCD0, /* 3280 */
  EVENT_NR5G_RRC_HO_FAILURE_V3                                                   = 0xCD1, /* 3281 */
  EVENT_F_RESERVED_91                                                            = 0xCD2, /* 3282 */
  EVENT_F_RESERVED_92                                                            = 0xCD3, /* 3283 */
  EVENT_LTE_MAC_RESET_V3                                                         = 0xCD4, /* 3284 */
  EVENT_LTE_UL_OUT_OF_SYNC_V3                                                    = 0xCD5, /* 3285 */
  EVENT_LTE_RACH_RAID_MATCH_V3                                                   = 0xCD6, /* 3286 */
  EVENT_LTE_TIMING_ADVANCE_V3                                                    = 0xCD7, /* 3287 */
  EVENT_LTE_ELS_MCE_BUILD_V2                                                     = 0xCD8, /* 3288 */
  EVENT_LTE_MAC_TIMER_V3                                                         = 0xCD9, /* 3289 */
  EVENT_LTE_BSR_SR_REQUEST_V3                                                    = 0xCDA, /* 3290 */
  EVENT_LTE_RACH_ACCESS_RESULT_V3                                                = 0xCDB, /* 3291 */
  EVENT_LTE_RACH_ACCESS_START_V3                                                 = 0xCDC, /* 3292 */
  EVENT_LTE_SPS_DEACTIVATED_V3                                                   = 0xCDD, /* 3293 */
  EVENT_LTE_RRC_IRAT_RESEL_FROM_EUTRAN_START_EXT_EARFCN                          = 0xCDE, /* 3294 */
  EVENT_WCDMA_ASDIV_TYPE1_SWITCH_RXAGC_BASED                                     = 0xCDF, /* 3295 */
  EVENT_WCDMA_ASDIV_PROBE_4WAY_ANTENNAS                                          = 0xCE0, /* 3296 */
  EVENT_NR5G_RRC_HO_FAILURE_V4                                                   = 0xCE1, /* 3297 */
  EVENT_F_RESERVED_93                                                            = 0xCE2, /* 3298 */
  EVENT_F_RESERVED_94                                                            = 0xCE3, /* 3299 */
  EVENT_LTE_POI_SIB1_DECODED                                                     = 0xCE4, /* 3300 */
  EVENT_EAP_HANDLE                                                               = 0xCE5, /* 3301 */
  EVENT_EAP_SIM_AKA_NOTIFY_STATUS                                                = 0xCE6, /* 3302 */
  EVENT_EAP_MESSAGE_INFO                                                         = 0xCE7, /* 3303 */
  EVENT_DS_EAPAUTH_SESSION_TIMER_STATUS                                          = 0xCE8, /* 3304 */
  EVENT_IPA_SWITCH_START                                                         = 0xCE9, /* 3305 */
  EVENT_IPA_SWITCH_END                                                           = 0xCEA, /* 3306 */
  EVENT_F_RESERVED_95                                                            = 0xCEB, /* 3307 */
  EVENT_NR5G_RRC_CELL_RESEL_SUCCESS                                              = 0xCEC, /* 3308 */
  EVENT_DS_URSP_CONFIG_UPDATE_STATUS                                             = 0xCED, /* 3309 */
  EVENT_F_RESERVED_96                                                            = 0xCF2, /* 3314 */
  EVENT_NR5G_RRC_CELL_RESEL_SUCCESS_V2                                           = 0xCF3, /* 3315 */
  EVENT_IPA_DL_RQOS_BATCH                                                        = 0xCF5, /* 3317 */
  EVENT_IPA_DL_RQOS_UID_RECORD                                                   = 0xCF6, /* 3318 */
  EVENT_IPA_DL_RQOS_AS_RECORD                                                    = 0xCF7, /* 3319 */
  EVENT_IPA_DL_RQOS_NAS_RECORD                                                   = 0xCF8, /* 3320 */
  EVENT_NR5G_RRC_RADIO_LINK_FAILURE_STAT_V5                                      = 0xCF9, /* 3321 */
  EVENT_V2X_DS_INTERFERENCE_DETECTION_CHANGE                                     = 0xCFA, /* 3322 */

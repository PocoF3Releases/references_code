...
Copyright (c) 1991-2021 Qualcomm Technologies, Inc.
All Rights Reserved.
...
/* 0x1A00-0x1BFF temporarily reserved for WLAN (under Equipment ID 1X) */
    ...
    #define LOG_WLAN_PMON_C                                 ((0xA1F) + LOG_1X_BASE_C)
...
/* 0x1C00-0x1C3F reserved */
	...
	#define LOG_NR5G_Q6_PDET_C                                ((0xC12) + LOG_1X_BASE_C)
	#define LOG_NR5G_RF_THIRD_PARTY_PA_C                      ((0xC18) + LOG_1X_BASE_C)
	#define LOG_NR5G_SUB6_TDD_BYPASS_C                        ((0xC1A) + LOG_1X_BASE_C)
	#define LOG_NR5G_SUB6_SDR_RXIU_C                          ((0xC1C) + LOG_1X_BASE_C)
...
#define LOG_RFLM_QLINK_GEAR_SPEED_C                           ((0xCEA) + LOG_1X_BASE_C)
#define LOG_FRPC_TX_RX_MSG_C                                  ((0xCEB) + LOG_1X_BASE_C)
#define LOG_FRPC_PROCESS_THREAD_C                             ((0xCEC) + LOG_1X_BASE_C)
#define LOG_FRPC_MAPPINGS_C                                   ((0xCED) + LOG_1X_BASE_C)
#define LOG_DS_UI_ICON_INFO_C                                 ((0xCEE) + LOG_1X_BASE_C)
#define LOG_EAP_SIM_AKA_IDENTITY_C                            ((0xCEF) + LOG_1X_BASE_C)
#define LOG_EAP_REQUEST_RESPONSE_DATA_PROTOCOL_C              ((0xCF0) + LOG_1X_BASE_C)
#define LOG_IPA_UL_SDAP_HDR_INFO_C                            ((0xCF1) + LOG_1X_BASE_C)
#define LOG_IMS_TEST_MEDIA_INFO_C                             ((0xCF2) + LOG_1X_BASE_C)
#define LOG_IMS_RTP_PAYLOAD_INFO_C                            ((0xCF3) + LOG_1X_BASE_C)
#define LOG_DS_DATA_TRAFFIC_FILTERING_INFO_C                  ((0xCF4) + LOG_1X_BASE_C)

/* Reserved IDs from 0x1CF5 - 0x1D04 for [License Category]->Proto->UE */

#define LOG_GNSS_APC_OFFSET_C                                 ((0xD05) + LOG_1X_BASE_C)
#define LOG_IMS_IRM_MESSAGE_INFO_C                            ((0xD06) + LOG_1X_BASE_C)
#define LOG_GNSS_VPE_FAILURE_C                                ((0xD07) + LOG_1X_BASE_C)
#define LOG_MODEM_DCVS_RESIDENCY_TABLE_DB_C                   ((0xD08) + LOG_1X_BASE_C)
#define LOG_SEC_TLS_HSP_CLIENT_HELLO_C                        ((0xD09) + LOG_1X_BASE_C)
#define LOG_SEC_TLS_HSP_SERVER_HELLO_C                        ((0xD0A) + LOG_1X_BASE_C)
#define LOG_IPA_ABM_C                                         ((0xD0B) + LOG_1X_BASE_C)
#define LOG_SNS_DIRECT_CHANNEL_REQUEST_C                      ((0xD0C) + LOG_1X_BASE_C)
#define LOG_Q6_PERIODIC_PERFORMANCE_MONITOR_STATISTICS_C      ((0xD0D) + LOG_1X_BASE_C)
#define LOG_QBI_EXTENDED_RX_MESSAGE_C                         ((0xD0E) + LOG_1X_BASE_C)
#define LOG_QBI_EXTENDED_TX_MESSAGE_C                         ((0xD0F) + LOG_1X_BASE_C)
#define LOG_DS_NR5G_PER_PDU_RB_LOG_INFO_C                     ((0xD10) + LOG_1X_BASE_C)
#define LOG_DATA_ARCH_PKT_TS_C                                ((0xD12) + LOG_1X_BASE_C)
#define LOG_DIAG_STRESS_TEST_RED_C                            ((0xD13) + LOG_1X_BASE_C)
#define LOG_SLL_DIAG_MESSAGE_C                                ((0xD14) + LOG_1X_BASE_C)
#define LOG_DIAG_WRAPPED_KEY_INFO_C                           ((0xD15) + LOG_1X_BASE_C)
#define LOG_Q6_TRANSIENT_PMON_C                               ((0xD16) + LOG_1X_BASE_C)
#define LOG_QDR_IPM_REPORT_C                                  ((0xD17) + LOG_1X_BASE_C)
#define LOG_MCPM_CP_2X_SCENARIO_C                             ((0xD18) + LOG_1X_BASE_C)
#define LOG_MCPM_CP_2X_CLIENT_C                               ((0xD19) + LOG_1X_BASE_C)
#define LOG_DS_RAN_ASST_RATE_INFO_C                           ((0xD1A) + LOG_1X_BASE_C)
#define LOG_DS_URSP_PDU_SESS_PARAM_LOOKUP_INFO_C              ((0xD1B) + LOG_1X_BASE_C)
#define LOG_DATA_PATH_CONTROL_MANAGER                         ((0xD1C) + LOG_1X_BASE_C)
#define LOG_TRM_ANT_SWITCH_C                                  ((0xD1D) + LOG_1X_BASE_C)
#define LOG_IFACE_ROUTING_C                                   ((0xD1E) + LOG_1X_BASE_C)
...
#define LOG_QPPE_DIAG_FAST_ENGINE_UPDT_RPT_C                  ((0xD26) + LOG_1X_BASE_C)
#define LOG_QPPE_DIAG_MEAS_RESID_RPT_C                        ((0xD27) + LOG_1X_BASE_C)
#define LOG_QPPE_DIAG_RTK_ENGINE_UPDT_RPT_C                   ((0xD28) + LOG_1X_BASE_C)
#define LOG_QPPE_DIAG_IAR_OUTPUT_RPT_C                        ((0xD29) + LOG_1X_BASE_C)
#define LOG_GNSS_ME_XIMEM_Status_C                            ((0xD2A) + LOG_1X_BASE_C)
#define LOG_MSTAT_C                                           ((0xD2B) + LOG_1X_BASE_C)
#define LOG_IMS_QDJ_STATISTICS                                ((0xD2C) + LOG_1X_BASE_C)
#define LOG_TRM_ANT_SWITCH_RFM_PATH_INFO_C                    ((0xD2D) + LOG_1X_BASE_C)
#define LOG_TRM_ANT_SWITCH_MR_ASDIV_INFO_C                    ((0xD2E) + LOG_1X_BASE_C)
#define LOG_SENSOR_SAMLITE_GYRO_CAL_BIAS_TEMP_TABLE_OUTPUT_C  ((0xD2F) + LOG_1X_BASE_C)
#define LOG_TRM_ANT_SWITCH_RETUNE_PATH_INFO_C                 ((0xD30) + LOG_1X_BASE_C)
#define LOG_TRM_ANT_SWITCH_GET_SWITCHABLE_ANTENNAS_API_C      ((0xD31) + LOG_1X_BASE_C)
#define LOG_TRM_ANT_SWITCH_IRAT_IFS_PATH_INFO_C               ((0xD32) + LOG_1X_BASE_C)
#define LOG_MS_TIMEINFO_C                                     ((0xD35) + LOG_1X_BASE_C)
#define LOG_PS_LOG_PKT_CMAPI_TYPE                             ((0xD36) + LOG_1X_BASE_C)
#define LOG_TRM_ANT_SWITCH_PLIMITS_INFO_C                     ((0xD38) + LOG_1X_BASE_C)
#define LOG_DATALNX_IP_STATS_C                                ((0xD3E) + LOG_1X_BASE_C)
#define LOG_DATALNX_ICMP_STATS_C                              ((0xD3F) + LOG_1X_BASE_C)
#define LOG_DATALNX_TCP_STATS_C                               ((0xD40) + LOG_1X_BASE_C)
#define LOG_DATALNX_UDP_STATS_C                               ((0xD41) + LOG_1X_BASE_C)
#define LOG_DATALNX_RMNET_DATA_STATS_C                        ((0xD42) + LOG_1X_BASE_C)
#define LOG_IPA_UL_MEM_USAGE_C                                ((0xD43) + LOG_1X_BASE_C)
#define LOG_ETH_IFACE_DEBUG_STATS_C                           ((0xD46) + LOG_1X_BASE_C)
#define LOG_IPA_UL_MEM_MGMT_CFG_C                             ((0xD49) + LOG_1X_BASE_C)
#define LOG_IPA_LNX_GENERIC_STATS_C                           ((0xD4A) + LOG_1X_BASE_C)
#define LOG_IPA_LNX_CLOCK_STATS_C                             ((0xD4B) + LOG_1X_BASE_C)
#define LOG_GNSS_IZAT_FLP_REPORT_C                            ((0xD4C) + LOG_1X_BASE_C)
#define LOG_IMS_CALL_SUMMARY_INFO_C                           ((0xD4D) + LOG_1X_BASE_C)
#define LOG_IPA_DL_RQOS_STATS_C                               ((0xD4E) + LOG_1X_BASE_C)
#define LOG_IPA_LNX_WLAN_INST_STATS_C                         ((0xD4F) + LOG_1X_BASE_C)
#define LOG_IPA_LNX_ETH_INST_STATS_C                          ((0xD50) + LOG_1X_BASE_C)
#define LOG_IPA_LNX_USB_INST_STATS_C                          ((0xD51) + LOG_1X_BASE_C)
#define LOG_IPA_LNX_MHIP_INST_STATS_C                         ((0xD52) + LOG_1X_BASE_C)
#define LOG_IMS_IMM_PDN_CONFIG_INFO_C                         ((0xD58) + LOG_1X_BASE_C)
#define LOG_GNSS_TUNNEL_STATUS_C                              ((0xD5E) + LOG_1X_BASE_C)

/* The last defined DMSS log code */
#define LOG_1X_LAST_C                                        ((0xD5E) + LOG_1X_BASE_C)

...
static jboolean stNfcManager_doInitialize(JNIEnv* e, jobject o) {
...

  {
    ...
    if (!nfc_sec_flag && stat == NFA_STATUS_OK && sIsNfaEnabled == false) {
...
static JNINativeMethod gMethods[] = {
    ...
    {"doCreateLlcpServiceSocket",
     "(ILjava/lang/String;III)Lcom/android/nfcstm/dhimpl/NativeLlcpServiceSocket;",

...
jstring nativeNfcStExtensions_rawJniSeq(JNIEnv *e, jobject o, jstring data) {
  nativeNfcTag_setInRawJniSeq(true);
  const char *str_data = e->GetStringUTFChars(data, 0);
  std::string ret = rawJniSeq(str_data);
  nativeNfcTag_setInRawJniSeq(false);
  return e->NewStringUTF(ret.c_str());
}
...
static JNINativeMethod gMethods[] = {
    ...
    {"rawJniSeq", "(Ljava/lang/String;)Ljava/lang/String;", (void *)nativeNfcStExtensions_rawJniSeq},

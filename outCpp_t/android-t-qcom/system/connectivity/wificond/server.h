...
class Server : public android::net::wifi::nl80211::BnWificond {
 public:
  ...
  // MIUI ADD : START
  android::binder::Status createP2pInterface(
      const std::string& iface_name,
      android::sp<android::net::wifi::nl80211::IP2pInterface>*
          created_interface) override;
  // MIUI ADD : END
  ...
  // MIUI ADD : START
  android::binder::Status tearDownP2pInterface(
      const std::string& iface_name,
      bool* out_success) override;
  // MIUI ADD : END
 ...
 private:
  ...
  // MIUI ADD
  std::map<std::string, std::unique_ptr<P2pInterfaceImpl>> p2p_interfaces_;

...
#define AUDIO_DEVICE_LIST_UNIQUE_DEF(V) \
    ...
    V(AUDIO_DEVICE_OUT_MULTIROUTE, 0x20000003u) \
...
#define AUDIO_OUTPUT_FLAG_LIST_DEF(V) \
    ...
    V(AUDIO_OUTPUT_FLAG_INCALL_MUSIC, 0x80000000) \
    V(AUDIO_OUTPUT_FLAG_GAPLESS_OFFLOAD, 0x20000) \
    V(AUDIO_OUTPUT_FLAG_SPATIALIZER, 0x40000) \
    V(AUDIO_OUTPUT_FLAG_ULTRASOUND, 0x80000) \
    V(AUDIO_OUTPUT_FLAG_VIRTUAL_DEEP_BUFFER, 0x40000000)\
    V(AUDIO_OUTPUT_FLAG_CAR_VOIP_RX, 0x10000000)
...
#define AUDIO_INPUT_FLAG_LIST_DEF(V) \
    ...
    V(AUDIO_INPUT_FLAG_INCALL_UPLINK_DOWNLINK, 0x80000000)\
    V(AUDIO_INPUT_FLAG_CAR_VOIP_TX, 0x200) \
    V(AUDIO_INPUT_FLAG_VOIP_RECORD , 0x400)
...
#define AUDIO_FORMAT_LIST_UNIQUE_DEF(V) \
    ...
    V(VX_AUDIO_FORMAT_APTX_ADAPTIVE_QLEA, 0x30000000u)
...
#define AUDIO_SOURCE_LIST_NO_SYS_DEF(V) \
    ...
    V(AUDIO_SOURCE_VOIP_UPLINK , 2999) \
    V(AUDIO_SOURCE_VOIP_DOWNLINK , 3000) \
    V(AUDIO_SOURCE_VOIP_CALL , 3001)
...
#define AUDIO_USAGE_LIST_NO_SYS_DEF(V) \
    ...
    V(AUDIO_USAGE_ENFORCED_AUDIBLE, 18) \
    V(AUDIO_USAGE_BLUETOOTH_SCO, 19) \
    V(AUDIO_USAGE_TTS, 20) \

...
enum effect_command_e {
   ...
   EFFECT_CMD_GET_INITIAL_ENABLED,  // get initial enabled flag
   EFFECT_CMD_SET_AUDIO_STANDBY,    // set the audio standby
   EFFECT_CMD_SET_APP_NAME,         // set the app name
   EFFECT_CMD_SET_STREAM_VOLUME,    // set stream volume
...
//  data: N/A
//==================================================================================================
// command: EFFECT_CMD_GET_INITIAL_ENABLED
//--------------------------------------------------------------------------------------------------
// description:
// Return no zero if effect need enable immediately after initialization
//--------------------------------------------------------------------------------------------------
// command format:
// size: 0
// data: N/A
...
// data: enabled
//==================================================================================================
// command: EFFECT_CMD_SET_AUDIO_STANDBY
//--------------------------------------------------------------------------------------------------
// description:
//  Notify effect audio system enters standby. The effect implementation must set
//  EFFECT_FLAG_AUDIO_STANDBY_IND flag in its descriptor to receive this command
//  when the audio system enters standby mode.
//--------------------------------------------------------------------------------------------------
// command format:
//  size: 0
//  data: N/A
...
//  data: status
//==================================================================================================
// command: EFFECT_CMD_SET_APP_NAME
//--------------------------------------------------------------------------------------------------
// description:
//  Set the app's name to effect. The effect implementation must set EFFECT_FLAG_APP_NAME_IND flag
//  in its descriptor to receive this command when the app play/stop/pause playback.
//--------------------------------------------------------------------------------------------------
// command format:
//  size: 256+sizeof(uint32_t)
//  data: stream type and app's name
//--------------------------------------------------------------------------------------------------
// reply format:
//  size: sizeof(int)
//  data: status
//==================================================================================================
// command: EFFECT_CMD_SET_STREAM_VOLUME
//--------------------------------------------------------------------------------------------------
// description:
//  Set the stream volume to effect. The effect implementation must set EFFECT_FLAG_STREAM_VOLUME_IND
//  flag in its descriptor to receive this command when the stream volume is changed.
//--------------------------------------------------------------------------------------------------
// command format:
//  size: sizeof(uint32_t)*2
//  data: stream type and volume
//--------------------------------------------------------------------------------------------------
// reply format:
//  size: sizeof(int)
//  data: status

...
typedef enum {
    ...
    AUDIO_FLAG_CAR_VOIP                   = 0x10000000,
    AUDIO_FLAG_INCALL_MUSIC               = 0X80000000,
} audio_flags_mask_t;
...
typedef enum {
    ...
    APP_TYPE_MAP                        = 0x1,
    APP_TYPE_ASSIST                     = 0x2,
    APP_TYPE_KARAOKE                    = 0x4,
    APP_TYPE_VOIP_SKYPE                 = 0x8,
    APP_TYPE_GAME_SHOOT                 = 0x10,
    APP_TYPE_CTS_AUDIOPRO               = 0x20,
    APP_TYPE_GOOGLE_OKGOOGLE            = 0x40,
    APP_TYPE_XIAOMI_SCREENRECORDER      = 0x80,
    APP_TYPE_RECORD_UNSILENCE           = 0x100,
    APP_TYPE_VOICE_TRIGGER              = 0X200,
    APP_TYPE_CAR                        = 0x800,
    APP_TYPE_CAMERA                     = 0x400,
} audio_app_type_f;
/* store app type here: end */

// AudioCpuSched start
typedef enum {
    AUDIO_SCHED_AT                      = 0x1,      // AudioTrack
    AUDIO_SCHED_AF                      = 0x2,      // AudioFlinger
    AUDIO_SCHED_HE                      = 0x4,      // HAL Effect
    AUDIO_SCHED_HB                      = 0x8,      // HAL Binder service
    AUDIO_SCHED_HSO                     = 0x10,     // HAL Stream Out
} audio_sched_type_t;
// AudioCpuSched end
...
/* AudioRoute cast */
#define AUDIO_PARAMETER_KEY_AUDIOROUTECAST "routecast"

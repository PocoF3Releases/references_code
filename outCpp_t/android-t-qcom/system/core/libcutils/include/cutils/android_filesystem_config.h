...
// MIUI ADD: Start
#define AID_BACKUP        6100  /* for Backup app */
#define AID_THEME         6101  /* for ThemeManager app */
#define AID_UPDATER       6102  /* for Updater app */
#define AID_FINDDEVICE    6110  /* for FindDevice app */
//  END

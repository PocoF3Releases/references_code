...
static const struct fs_path_config android_dirs[] = {
    ...
    { 00771, AID_SYSTEM,       AID_SYSTEM,       0, "data/local/maintenance_mode" },
    { 00770, AID_DHCP,         AID_DHCP,         0, "data/misc/dhcp" },
    { 00775, AID_SYSTEM, AID_SYSTEM, 0, "data/miui/cust" },
    { 00775, AID_SYSTEM, AID_SYSTEM, 0, "data/miui" },
...
#if (FACTORY_BUILD == 1) || (ENABLE_MIUI_DEBUGGING == 1)
...
static const struct fs_path_config android_files[] = {
    ...
    { 00644, AID_SYSTEM,    AID_SYSTEM,    0, "data/miui/cust/*" },
    { 00644, AID_SYSTEM,    AID_SYSTEM,    0, "data/miui/*" },

...
bool retrieveOrGenerateKey(const std::string& key_path, const std::string& tmp_path,
                           ...
                           KeyBuffer* key);
// Retrieves the key from the backup named directory
...
// Backup the encrypted key, when key operation success
void backupKey(const std::string& key_path, const std::string& key_path_backup);

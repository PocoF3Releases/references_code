...
static int wpas_hidl_register_interface(struct wpa_supplicant *wpa_s)
{
    return 0;
}
static int wpas_hidl_unregister_interface(struct wpa_supplicant *wpa_s)
{
    return 0;
}
static int wpas_hidl_register_network(
    struct wpa_supplicant *wpa_s, struct wpa_ssid *ssid)
{
    return 0;
}
static int wpas_hidl_unregister_network(
    struct wpa_supplicant *wpa_s, struct wpa_ssid *ssid)
{
    return 0;
}
static int wpas_hidl_notify_state_changed(struct wpa_supplicant *wpa_s)
{
    return 0;
}
static int wpas_hidl_notify_network_request(
    struct wpa_supplicant *wpa_s, struct wpa_ssid *ssid,
...
static void wpas_hidl_notify_ap_sta_deauthorized(
    struct wpa_supplicant *wpa_s, const u8 *sta, const u8 *p2p_dev_addr) {}
static void wpas_hidl_notify_eap_error(struct wpa_supplicant *wpa_s, int error_code) {}
//DPP Notifications

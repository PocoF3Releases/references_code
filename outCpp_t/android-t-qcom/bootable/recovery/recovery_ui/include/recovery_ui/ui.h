...
class RecoveryUI {
 public:
  ...
  // MIUI ADD: START
  virtual void SetCurrentState(bool state) {};
  virtual void InitLanguageSpecificResource(const char *language) {};
  virtual int GetMenuSelection(const char* id, int menu_only,
                               int initial_selection, Device* device) { return 0;};
  virtual void StartMenu(const char *id, int initial_selection) {};

  // sub menus
  virtual int SubMenuReboot(Device* device) { return 0;};

  virtual void StartMenu(const char* const * headers, const char* const * items,
                         int initial_selection) {};
  virtual int SubMenuWipeCmdWipePartial(void) { return 0;};
  ...
  virtual int SubMenuApplyExt(Device* device, const char*  verification_msg,
                              const char* update_package, bool should_wipe_cache, int retry_count, bool install_with_fuse) {return 0;};
  virtual int SubMenuWipe() { return 0;};
  virtual int SubMenuWipeCmdWipeCache(void) { return 0;};
  virtual int SubMenuWipeCmdWipeData(bool convert_fbe) { return 0;};
  virtual int SubMenuWipeCmdFormatData(void) { return 0;};
  virtual int SubMenuWipeCmdFormatStorage(void) { return 0;};
  virtual int SubMenuWipeCmdWipeEfs(void) { return 0;};

  virtual int StartInstallPackage(const char* path, bool* wipe_cache, const char* install_file,
                                  bool needs_mount, char* verification_msg, bool sideload = false) { return 0;};
  virtual void SetVersionMismatch(bool is_mismatch) {};
  virtual void SetNVdataCorrupted(bool is_NVcorrupted) {};
  virtual void SetShowMaintenanceMode(bool is_supportMaintenanceMode) {};
  virtual void SetRamdumpPresented(bool has) {};
  virtual Device* GetDevice() { return nullptr;}
  virtual void SetDevice(Device* device) {};
  virtual void SetBootMonitor(bool is_bootmonitor) {};
  virtual void SetEnableFileCryptoFailed(bool is_enablefilecryptofailed) {};
  virtual void SetFsMgrMountAll(bool is_fsmgrmountall) {};
  virtual void SetInitUser0Failed(bool is_inituser0failed) {};
  virtual void SetRescueParty(bool is_rescueparty) {};
  virtual void SetPolicyFailed(bool is_setpolicyfailed) {};
// END

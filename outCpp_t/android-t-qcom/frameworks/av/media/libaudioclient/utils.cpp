...
static app_audiorecord_info_list_t voip_tx_game_app_list[] = {
    ...
    [APP_ID_VOIP_PUBGMHD] = {"com.tencent.tmgp.pubgmhd", AUDIO_SOURCE_DEFAULT, 16000, AUDIO_FORMAT_PCM_16_BIT, 0x10},
    // voip audiorecord: AUDIO_SOURCE_DEFAULT/16000Hz/16bit/0x10
    [APP_ID_VOIP_PUBGM] = {"com.tencent.tmgp.pubgm", AUDIO_SOURCE_DEFAULT, 16000, AUDIO_FORMAT_PCM_16_BIT, 0x10},
    // voip audiorecord: AUDIO_SOURCE_DEFAULT/16000Hz/16bit/0x10
    [APP_ID_VOIP_WZRY] = {"com.tencent.tmgp.sgame", AUDIO_SOURCE_DEFAULT, 16000, AUDIO_FORMAT_PCM_16_BIT, 0x10},
    // voip audiorecord: AUDIO_SOURCE_DEFAULT/44100Hz/16bit/0x10
    [APP_ID_VOIP_HYXD] = {"com.netease.hyxd.mi", AUDIO_SOURCE_MIC, 44100, AUDIO_FORMAT_PCM_16_BIT, 0x10},
    // voip audiorecord: AUDIO_SOURCE_DEFAULT/16000Hz/16bit/0x10
    [APP_ID_VOIP_IG] = {"com.tencent.ig", AUDIO_SOURCE_DEFAULT, 16000, AUDIO_FORMAT_PCM_16_BIT, 0x10},
    // voip audiorecord: AUDIO_SOURCE_DEFAULT/16000Hz/16bit/0x10
    [APP_ID_VOIP_CLDT] = {"com.activision.callofduty.shooter", AUDIO_SOURCE_DEFAULT, 16000, AUDIO_FORMAT_PCM_16_BIT, 0x10}
};
...
static app_audiotrack_info_list_t fourD_game_app_list[] = {
    ...
    //[APP_ID_4D_PUBGMHD] = {"com.tencent.tmgp.pubgmhd", AUDIO_STREAM_MUSIC, 48000, AUDIO_FORMAT_PCM_16_BIT, 0x3},
    // shoot sound: AUDIO_STREAM_MUSIC/48000/16bit/0x3
    //[APP_ID_4D_PUBGM] = {"com.tencent.tmgp.pubgm", AUDIO_STREAM_MUSIC, 48000, AUDIO_FORMAT_PCM_16_BIT, 0x3},
    // shoot sound: AUDIO_STREAM_MUSIC/24000/16bit/0x3
    [APP_ID_4D_HYXD] = {"com.netease.hyxd.mi", AUDIO_STREAM_MUSIC, 24000, AUDIO_FORMAT_PCM_16_BIT, 0x3}
};

static app_audiotrack_info_list_t voip_rx_game_app_list[] = {
    // voip stream type: AUDIO_STREAM_MUSIC/16000Hz/16bit/0x1
    [APP_ID_VOIP_PUBGMHD] = {"com.tencent.tmgp.pubgmhd", AUDIO_STREAM_MUSIC, 16000, AUDIO_FORMAT_PCM_16_BIT, 0x1},
    // voip stream type: AUDIO_STREAM_MUSIC/16000Hz/16bit/0x1
    [APP_ID_VOIP_PUBGM] = {"com.tencent.tmgp.pubgm", AUDIO_STREAM_MUSIC, 16000, AUDIO_FORMAT_PCM_16_BIT, 0x1},
    // voip stream type: AUDIO_STREAM_MUSIC/16000Hz/16bit/0x1
    [APP_ID_VOIP_WZRY] = {"com.tencent.tmgp.sgame", AUDIO_STREAM_MUSIC, 16000, AUDIO_FORMAT_PCM_16_BIT, 0x1},
    // voip stream type: AUDIO_STREAM_DEFAULT/48000Hz/16bit/0x1
    [APP_ID_VOIP_HYXD] = {"com.netease.hyxd.mi", AUDIO_STREAM_DEFAULT, 48000, AUDIO_FORMAT_PCM_16_BIT, 0x1},
    // voip stream type: AUDIO_STREAM_MUSIC/16000Hz/16bit/0x1
    [APP_ID_VOIP_IG] = {"com.tencent.ig", AUDIO_STREAM_MUSIC, 16000, AUDIO_FORMAT_PCM_16_BIT, 0x1},
    // voip stream type: AUDIO_STREAM_MUSIC/16000Hz/16bit/0x1
    [APP_ID_VOIP_CLDT] = {"com.activision.callofduty.shooter", AUDIO_STREAM_MUSIC, 16000, AUDIO_FORMAT_PCM_16_BIT, 0x1}
};

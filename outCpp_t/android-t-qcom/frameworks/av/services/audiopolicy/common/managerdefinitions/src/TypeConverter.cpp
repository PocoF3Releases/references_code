...
const DeviceCategoryConverter::Table DeviceCategoryConverter::mTable[] = {
    ...
    MAKE_STRING_FROM_ENUM(DEVICE_CATEGORY_HEADSET_CE),
    MAKE_STRING_FROM_ENUM(DEVICE_CATEGORY_SPEAKER),
    MAKE_STRING_FROM_ENUM(DEVICE_CATEGORY_SPEAKER_OLD),
    ...
    MAKE_STRING_FROM_ENUM(DEVICE_CATEGORY_A2DP),
    MAKE_STRING_FROM_ENUM(DEVICE_CATEGORY_A2DP_CE),
    MAKE_STRING_FROM_ENUM(DEVICE_CATEGORY_USB),
    MAKE_STRING_FROM_ENUM(DEVICE_CATEGORY_USB_CE),
    TERMINATOR
};

...
enum device_category {
    ...
    DEVICE_CATEGORY_SPEAKER_OLD,
    DEVICE_CATEGORY_EARPIECE,
    DEVICE_CATEGORY_EXT_MEDIA,
    DEVICE_CATEGORY_HEARING_AID,
    DEVICE_CATEGORY_HEADSET_CE,
    DEVICE_CATEGORY_A2DP,
    DEVICE_CATEGORY_A2DP_CE,
    DEVICE_CATEGORY_USB,
    DEVICE_CATEGORY_USB_CE,
    DEVICE_CATEGORY_CNT
};
...
public:
    ...
    static device_category getDeviceCategory(const android::DeviceTypeSet& deviceTypes)
    {
        ...
        case AUDIO_DEVICE_OUT_BLUETOOTH_A2DP_HEADPHONES:
            return DEVICE_CATEGORY_A2DP;
        case AUDIO_DEVICE_OUT_USB_HEADSET:
            return DEVICE_CATEGORY_USB;

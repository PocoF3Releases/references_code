...
#define SL_ANDROID_POSITIONAL_SPEAKER_MASK_ALL  \
        ...
        | SL_SPEAKER_TOP_SIDE_LEFT /* DOLBY_ENABLE && DOLBY_ATMOS_GAME */ \
        | SL_SPEAKER_TOP_SIDE_RIGHT /* DOLBY_ENABLE && DOLBY_ATMOS_GAME */ )
...
#define SL_ANDROID_SPEAKER_5DOT1DOT2 (SL_SPEAKER_FRONT_LEFT | SL_SPEAKER_FRONT_RIGHT \
        | SL_SPEAKER_FRONT_CENTER  | SL_SPEAKER_LOW_FREQUENCY| SL_SPEAKER_BACK_LEFT \
        | SL_SPEAKER_BACK_RIGHT | SL_SPEAKER_TOP_SIDE_LEFT | SL_SPEAKER_TOP_SIDE_RIGHT)
// MIUI END

...
const common::SensorStrength kSensorStrength = common::SensorStrength::CONVENIENCE;
...
ndk::ScopedAStatus Face::createSession(int32_t sensorId, int32_t userId,
    ...
    ALOGD("createSession");
    *return_val = SharedRefBase::make<Session>(sensorId, userId, cb);
    return ndk::ScopedAStatus::ok();
}

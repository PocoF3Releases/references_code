...
struct p2p_config {
	...
	/**
	 * p2p_chan_list_dfs_disable - Enable DFS channel in channel list
	 */
	bool p2p_chan_list_dfs_disable;

	/**
	 * p2p_chan_list_only_sta_dfs_enable - Enable DFS channel
	 * in channel list only when sta connect to dfs.
	 * need set p2p_chan_list_only_sta_dfs_enable=0
	 */
	bool p2p_chan_list_only_sta_dfs_enable;

	/**
	 * p2p_pref_list_dfs_disable - Enable DFS channel in pref channel list
	 */
	bool p2p_pref_list_dfs_disable;

	/**
	 * p2p_go_dfs_disable - Enable DFS channel for GO
	 */
	bool p2p_go_dfs_disable;
...
int p2p_remove_dfs_channels(struct weighted_pcl *pref_freq_list, int size);

...
#define DEFAULT_ASSOCIATE_OPEN_6G 0
...
#define MAX_SEC_DEVICE_TYPES 5
	...
	int p2p_chan_list_dfs_disable;
	int p2p_chan_list_only_sta_dfs_enable;
	int p2p_pref_list_dfs_disable;
	int p2p_go_dfs_disable;
...
#define DEFAULT_P2P_GO_FREQ_MOVE P2P_GO_FREQ_MOVE_STAY
	...
	/**
	 * associate_open_6G - Connect 6G in open mode
	 */
	int associate_open_6G;

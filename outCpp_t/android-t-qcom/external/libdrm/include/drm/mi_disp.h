...
static inline bool is_support_disp_id(__u32 disp_id)
{
...
static inline bool is_support_doze_brightness(__u32 doze_brightness)
{
...
static inline bool is_aod_brightness(__u32 doze_brightness)
{
...
#else
static inline bool isSupportDispId(__u32 disp_id)
{
	if (disp_id < MI_DISP_MAX)
		return 1;
	else
...
static inline bool isSupportDozeBrightness(__u32 doze_brightness)
{
	if (doze_brightness < DOZE_BRIGHTNESS_MAX)
		return 1;
	else
...
static inline bool isAodBrightness(__u32 doze_brightness)
{
	if (DOZE_BRIGHTNESS_HBM == doze_brightness ||
		doze_brightness == DOZE_BRIGHTNESS_LBM)
		return 1;
...
static inline bool isSupportDispEventType(__u32 event_type)
{
	if (event_type < MI_DISP_EVENT_MAX)
		return 1;
	else
...
static inline bool isSupportDispFeatureId(__u32 feature_id)
{
	if (feature_id < DISP_FEATURE_MAX)
		return 1;
	else
